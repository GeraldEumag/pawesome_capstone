...
const ManagerDashboard = () => {
  ...
  const quickActions = [
    {
      title: "Reports",
      description: "View sales, payment, inventory, service, and customer reports.",
      icon: faChartLine,
      path: "/manager/reports",
    },
    {
      title: "Staff Management",
      description: "Manage employee records and workforce performance.",
      icon: faUsers,
      path: "/manager/staff",
    },
    {
      title: "Attendance Kiosk",
      description: "Open the barcode attendance kiosk for staff check-in/check-out.",
      icon: faTableCells,
      path: "/manager/attendance/kiosk",
    },
    {
      title: "Attendance Records",
      description: "Review and manage daily attendance records.",
      icon: faCalendarAlt,
    ...
    {
      title: "Payroll",
      description: "Manage payroll records and compute staff salaries.",
      icon: faMoneyBill,
      path: "/manager/payroll",
    },
    {
      title: "History / Audit Trail",
      description: "Review business activity and system audit logs.",
      icon: faHistory,
