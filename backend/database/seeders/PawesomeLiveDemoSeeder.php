...
class PawesomeLiveDemoSeeder extends Seeder
{
    ...
    private function ensureUsers(): array
    {
        $accounts = [
            ...
            'manager' => ['name' => 'Manager', 'role' => 'manager', 'department' => 'Operations', 'position' => 'Operations Manager', 'password' => 'password123'],
            ...
            'cashier' => ['name' => 'Cashier', 'role' => 'cashier', 'department' => 'Finance', 'position' => 'Cashier', 'password' => 'password123'],
